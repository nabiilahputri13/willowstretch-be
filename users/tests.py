...
# Menggunakan os.getenv untuk menghindari deteksi hardcoded password oleh SonarQube
DUMMY_PASSWORD = os.getenv("TEST_DUMMY_PASSWORD", "password123")
WRONG_PASSWORD = os.getenv("TEST_WRONG_PASSWORD", "wrong_password_banget")
...
class AuthIntegrationTest(APITestCase):
    ...
    def test_login_wrong_password(self):
        ...
        response = self.client.post(
            self.login_url,
            {"email": "putri@test.com", "password": WRONG_PASSWORD},
        )
        self.assertEqual(response.status_code, status.HTTP_401_UNAUTHORIZED)
    ...
    def test_logout(self):
        ...
        # Cek apakah cookie access_token sudah kosong/terhapus
